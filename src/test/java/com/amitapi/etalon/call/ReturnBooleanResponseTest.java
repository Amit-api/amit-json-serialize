...
public class ReturnBooleanResponseTest extends TestBase {
	@Test
	public void test_DS_Empty() throws JsonParseException, IOException,
			BaseException, MyArrayException {
		try (JsonParser jp = parser("      ")) {
			CallInterfaceReturn.ReturnBooleanResponse resp = CallInterfaceReturn.ReturnBooleanResponse
					.readDynamic(jp);
			resp.throwException();
		}
	}
	...
	public void test_SZ_Empty() throws JsonParseException, IOException {
		...
		try (JsonGenerator jg = generator(writer)) {
			CallInterfaceReturn.ReturnBooleanResponse.writeDynamic(jg,
					new CallInterfaceReturn.ReturnBooleanResponse());
		}
	...
	public void test_DS_InvalidImput() throws JsonParseException, IOException {
		try (JsonParser jp = parser("hello")) {
			CallInterfaceReturn.ReturnBooleanResponse.readDynamic(jp);
		}
	}
	...
	public void test_DS_returnValue_HasValue() throws JsonParseException,
			IOException, BaseException, MyArrayException {
		try (JsonParser jp = parser("{\"result\": true}")) {
			CallInterfaceReturn.ReturnBooleanResponse resp = CallInterfaceReturn.ReturnBooleanResponse
					.readDynamic(jp);
			resp.throwException();
			assertEquals(true, resp.getReturnValue());
		}
	}
