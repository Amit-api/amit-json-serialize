...
public class ReturnBooleanArrResponseTest extends TestBase {
	@Test
	public void test_DS_Empty() throws JsonParseException, IOException,
			BaseException, MyArrayException {
		try (JsonParser jp = parser("      ")) {
			CallInterfaceReturn.ReturnBooleanArrResponse resp = CallInterfaceReturn.ReturnBooleanArrResponse
					.readDynamic(jp);
			resp.throwException();
		}
	}
	...
	public void test_SZ_Empty() throws JsonParseException, IOException {
		...
		try (JsonGenerator jg = generator(writer)) {
			CallInterfaceReturn.ReturnBooleanArrResponse.writeDynamic(jg,
					new CallInterfaceReturn.ReturnBooleanArrResponse());
		}
	...
	public void test_DS_InvalidImput() throws JsonParseException, IOException {
		try (JsonParser jp = parser("hello")) {
			CallInterfaceReturn.ReturnBooleanArrResponse.readDynamic(jp);
		}
	}
	...
	public void test_DS_returnValue_HasValue() throws JsonParseException,
			IOException, BaseException, MyArrayException {
		try (JsonParser jp = parser("{\"result\": [true, false]}")) {
			CallInterfaceReturn.ReturnBooleanArrResponse resp = CallInterfaceReturn.ReturnBooleanArrResponse
					.readDynamic(jp);
			resp.throwException();
			assertEquals(Arrays.asList(true, false), resp.getReturnValue());
		}
	}
	...
	public void test_SZ_returnValue_HasValue() throws JsonParseException,
		...
		try (JsonGenerator jg = generator(writer)) {
			CallInterfaceReturn.ReturnBooleanArrResponse.writeDynamic(jg,
					new CallInterfaceReturn.ReturnBooleanArrResponse()
							.withReturnValue(Arrays.asList(true, false)));
		}

		assertEquals("{\"result\":[true,false]}", writer.toString());
	}
}